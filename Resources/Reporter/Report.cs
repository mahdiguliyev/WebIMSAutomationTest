...
namespace Resources.Reporter
{
    public static class Report
    {
        private static readonly Logger TheLogger = LogManager.GetCurrentClassLogger();
        private static ExtentReports ReportManager { get; set; } //allow to create report
        ...
        public static void ReportTestOutcome(string screenshotPath)
        {
            ...
            switch (status)
            {
                ...
                case UnitTestOutcome.Inconclusive:
                    CurrentTestCase.AddScreenCaptureFromPath(screenshotPath);
                    CurrentTestCase.Fail("Inconclusive");
                    break;
                case UnitTestOutcome.Unknown:
                    CurrentTestCase.Skip("Skipped");
                    break;
                default:
